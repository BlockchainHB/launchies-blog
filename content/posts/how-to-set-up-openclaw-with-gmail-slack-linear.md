...
This guide walks through connecting OpenClaw to the three tools that form the backbone of most startup operations: Gmail, Slack, and Linear. If you follow along, you'll have a fully connected AI agent in about an hour.
...
1. **An OpenClaw account** — sign up at [openclaw.com](https://openclaw.com)
...
OpenClaw needs to understand your Linear setup — teams, workflow states, labels, and projects. The first time it connects, it'll map these automatically. But it's worth reviewing:
