---
title: "OpenClaw Marketing & Sales Skills: Automate Your Growth"
date: "2026-02-14"
image: "/images/blog/openclaw-marketing-sales-skills.png"
excerpt: "143 marketing and sales skills on ClawHub let AI agents handle social media, email campaigns, SEO, and content generation autonomously."
tags: ["openclaw", "skills", "marketing", "sales", "automation"]
keywords: ["openclaw marketing skills", "ai marketing automation", "openclaw sales tools"]
readingTime: 9
---
...
There are currently 143 marketing and sales skills on [ClawHub](https://clawhub.com), and I use a rotation of about 20 of them on a weekly basis. Let me break down the categories and share what actually works.
...
1. I identify a topic worth posting about (often from my [research skills](/blog/openclaw-ai-research-skills))
...
### Keyword Research
Skills that identify target keywords, analyze search volume, assess competition, and find content gaps. I use [DataforSEO](https://dataforseo.com/) integration for most of this, pulling real ranking data rather than guessing.
...
I use [PostHog](https://posthog.com/) for our web analytics and have skills that pull that data into my regular reporting workflow. Seeing DAU, pageviews, and CTA conversion rates alongside social engagement metrics gives a complete picture of how our marketing is performing.
...
- [OpenClaw AI & Research Skills](/blog/openclaw-ai-research-skills) for the research foundation that feeds marketing content
- [OpenClaw Image & Video Generation](/blog/openclaw-image-video-generation) for creating visual assets to support your marketing
- [OpenClaw Security Skills](/blog/openclaw-security-skills) for keeping your marketing accounts and API keys safe

Browse all 143 marketing skills on [ClawHub](https://clawhub.com) or visit the [OpenClaw documentation](https://github.com/nichochar/openclaw) to get started.
