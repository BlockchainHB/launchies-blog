---
title: "The Ultimate Guide to OpenClaw Productivity Skills"
date: "2026-02-14"
image: "/images/blog/openclaw-productivity-skills-guide.png"
excerpt: "A comprehensive guide to the 135 productivity skills on ClawHub, covering Google Workspace, Notion, Slack, Linear, and more."
tags: ["openclaw", "skills", "productivity", "notion", "gmail", "google-workspace"]
keywords: ["openclaw productivity skills", "ai productivity tools", "openclaw notion slack gmail"]
readingTime: 9
---
...
The `gog` skill is the most important productivity skill in the OpenClaw ecosystem. I ranked it #1 in my [Best OpenClaw Skills to Install in 2026](/blog/best-openclaw-skills-2026) list, and that was not a close call. It connects six Google services through a single OAuth authentication:
...
The 135 productivity skills on [ClawHub](https://clawhub.com) cover the full spectrum of task and project management:
...
1. **Google Workspace (gog)**: Email, calendar, documents, and contacts
2. **Notion** or your preferred note/knowledge tool
3. **Apple Reminders** or your preferred task manager

### Team Tier (If Working with Others)

4. **Linear** or your project tracker (Trello, Asana, Jira)
5. **Slack** or your team messaging platform
6. **GitHub** for code collaboration

### Enhancement Tier (Quality of Life)

7. **Summarize** for information processing
8. **Weather** for proactive daily planning
9. **Web Search** for quick research during work
...
1. Check email for urgent messages, summarize the inbox
2. Review today's calendar events and prepare for the first meeting
3. Check Linear for any new high-priority issues
4. Review Apple Reminders due today
5. Check weather for the day
6. Post a summary to the human with anything requiring attention
...
1. Create a Linear project with milestones
2. Set up a Notion knowledge base with templates
3. Create a shared Google Drive folder
4. Schedule kickoff meeting via Calendar
5. Post announcement to the Slack channel
6. Create initial issues in Linear from the project brief
...
The 135 productivity skills on [ClawHub](https://clawhub.com) cover every major productivity platform and workflow. The key is not installing everything, but building a focused stack that matches your actual work patterns and letting the skills work together.

Start with Google Workspace, add your preferred project tracker and note tool, and build from there. The [awesome-openclaw-skills](https://github.com/anthropics/awesome-openclaw-skills) list is the best place to discover new productivity skills as they are released.

Related guides:
- [Best OpenClaw Skills to Install in 2026 (Top 25 Ranked)](/blog/best-openclaw-skills-2026)
- [OpenClaw Smart Home Skills: Control Your Home with AI](/blog/openclaw-smart-home-skills)
- [OpenClaw Browser Automation: Web Scraping and Testing with AI](/blog/openclaw-browser-automation-skills)
- [OpenClaw DevOps & Cloud Skills: Docker, AWS, and CI/CD with AI](/blog/openclaw-devops-cloud-skills)
